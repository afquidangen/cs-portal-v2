...
const CATEGORY_ALIASES: Record<string, string[]> = {
  ...
  assignment: ["assignment", "assignments", "assignment project", "project assignment", "homework", "task", "activity", "activities", "seatwork"],
  assignments: ["assignment", "assignments", "assignment project", "project assignment", "homework", "task", "activity", "activities", "seatwork"],
  ...
  "assignment project": ["assignment", "assignments", "assignment project", "homework", "task", "activity", "activities", "seatwork"],
  "project assignment": ["assignment", "assignments", "project assignment", "homework", "task", "activity", "activities", "seatwork"],
  attendance: ["attendance", "attend", "atten", "att", "present", "absent", "tardy", "lec attendance", "lecture attendance", "lab attendance", "laboratory attendance"],
  ...
  exam: ["exam", "examination", "midterm", "final", "prelim", "midterm exam", "final exam", "prelim exam", "midterm examination", "final examination"],
  midterm: ["exam", "examination", "midterm", "final", "prelim", "midterm exam", "final exam", "prelim exam", "midterm examination", "final examination"],
  final: ["exam", "examination", "midterm", "final", "prelim", "midterm exam", "final exam", "prelim exam", "midterm examination", "final examination"],
